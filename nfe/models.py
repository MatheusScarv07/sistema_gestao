...
class NFE(models.Model):
    ...
    nome_fornecedor = models.CharField(max_lenght=70,null=True, blank=True)
    cnpj = models.CharField(max_lenght=14,null=True, blank=True)
    data_emissao = models.DateTimeField(null=True, blank=True)
    numero_nota = models.CharField(null=True, blank=True)
    produto = models.ForeignKey(Stock, on_delete=models.SET_NULL, null=True, blank=True)
    nome_produto = models.CharField(null=True, blank=True)
